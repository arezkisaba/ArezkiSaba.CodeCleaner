...
public sealed class CodeCleanerTests
{
    ...
    [Test]
    public async Task CleanAsync_ContentAfterRefactoring_EqualsTo_ExpectedContentAsync()
    {
        ...
        workspace = await workspace.RefactorAsync(smallRefactor: false, displayOutput: false);
